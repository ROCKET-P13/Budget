...
export class BudgetApiInfrastructureStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
	...
	const apiLambda = new lambda.Function(this, 'ApiLambda', {
		...
		handler: 'BudgetAPI::BudgetAPI.LambdaEntryPoint::FunctionHandlerAsync',
		code: lambda.Code.fromAsset(
			path.join(__dirname, '../../BudgetAPI/bin/Release/net8.0/publish')
		),
		vpc,
